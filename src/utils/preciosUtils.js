...
export const ajustarPrecio = (precioOriginal) => {
  ...
  else if (precio < 9000) precioAjustado += 6000;
  else if (precio < 10000) precioAjustado += 6000;
  else if (precio < 11000) precioAjustado += 6500;
  else if (precio < 12000) precioAjustado += 7000;
  else if (precio < 13000) precioAjustado += 7500;
  else if (precio < 14000) precioAjustado += 7500;
  else if (precio < 15000) precioAjustado += 7500;
  else if (precio < 16000) precioAjustado += 7500;
  else if (precio < 30000) precioAjustado += 9000;
  else if (precio < 40000) precioAjustado += 12000;
  else if (precio < 50000) precioAjustado += 14000;
  else if (precio < 60000) precioAjustado += 15000;
  else if (precio < 70000) precioAjustado += 16000;
  else if (precio < 80000) precioAjustado += 17000;
